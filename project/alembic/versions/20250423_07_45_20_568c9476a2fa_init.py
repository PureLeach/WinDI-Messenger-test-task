...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['chat_id'], ['chats.id'], name=op.f('fk_group_participants_chat_id_chats'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_group_participants_user_id_users'), ondelete='CASCADE'),
